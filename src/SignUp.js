            ...
            <img className={style.restaurant2} src="/assets/restaurant.png"/>
              <div className={style.details}>
                ...
                <div className={style.googlebutton}> 
                  <button type="button" className={style.btn}>Sign up with google</button>
                </div>
                <div className={style.form}>
                  <form action="/">
                    <div className={style.section1}>
                      <label className={style.email}>Your email</label>
                      <input type="text" id="mail" name="email" placeholder="stuff@gmail.com.."/>
                    </div>
                    ...
                    <div className={style.section3}>  
                      <button type="button" className={style.btn2}>Sign Up</button>
                    </div>
                  </form>    
                  </div>
